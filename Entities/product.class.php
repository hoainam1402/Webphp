...
class Product
{
    ...
    {
        $db = new Db();
        $sql = "SELECT product_ID,product_Name,category_ID,category_Name,price,quantity,picture FROM product  INNER JOIN category where product.category_ID = category.cate_ID";
    ...
    {
        $db = new Db();
        $sql = "SELECT product_ID,product_Name,category_ID,category_Name,price,quantity,picture FROM product  INNER JOIN category  WHERE product_ID = '$product_ID'";
        $result = $db->select_to_array($sql);
        return $result;
    }
