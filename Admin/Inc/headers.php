<!DOCTYPE html>
<?php include_once("../Admin/secure.php"); ?>
<html>
<head>
    <!-- Required meta tags-->
    <meta charset="utf-8">
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="../Content/img/Logo-shop.png" alt="Cool Admin" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="admin.php">
                                <i class="far fa-check-square"></i>Quản Lý Người Dùng</a>
                        </li>
                        <li>
                            <a href="calendar.html">
                                <i class="fas fa-calendar-alt"></i>Thông tin đơn hàng</a>
                        </li>
                        <li>
                            <a href="map.html">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="<?php echo $avatar ?>" alt="<?php echo $user ?>" />
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#"><?php echo $user ?></a><a>Địa chỉ:<br><?php echo $address ?></a>
                                                    </h5>
                                                </div>
                                            </div>
